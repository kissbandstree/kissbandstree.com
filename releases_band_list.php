...
<body>
  ...
  <div class="standard">
    ...
    foreach ($releaseFiles as $txtFile) {
      ...
      echo '<h2>';
      echo '<span class="band-photo-wrap"><a href="release_band.php?a=' . urlencode($slug) . '"><img src="' . htmlspecialchars($imgUrl, ENT_QUOTES, 'UTF-8') . '" alt="' . htmlspecialchars($title, ENT_QUOTES, 'UTF-8') . '" class="band-photo bitmap"></a></span>';
      echo '<a href="release_band.php?a=' . urlencode($slug) . '">' . htmlspecialchars($artist, ENT_QUOTES, 'UTF-8') . ' - "' . htmlspecialchars($title, ENT_QUOTES, 'UTF-8') . '"</a>';
      echo '</h2>';
