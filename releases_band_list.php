...
<body>
  ...
  <div class="standard">
    ...
    foreach ($releaseFiles as $txtFile) {
      ...
      echo '<a href="release_band.php?a=' . urlencode($slug) . '" class="thumb-link"><span class="band-photo-wrap"><img src="' . htmlspecialchars($imgUrl, ENT_QUOTES, 'UTF-8') . '" alt="' . htmlspecialchars($title, ENT_QUOTES, 'UTF-8') . '" class="band-photo bitmap"></span></a>';
      echo '<a href="release_band.php?a=' . urlencode($slug) . '" class="artist-name">' . htmlspecialchars($artist, ENT_QUOTES, 'UTF-8') . ' - "' . htmlspecialchars($title, ENT_QUOTES, 'UTF-8') . '"</a>';
      echo '</h2>';
